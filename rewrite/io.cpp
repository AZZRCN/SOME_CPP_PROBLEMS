...
public:
    ...
    inline __attribute__((__always_inline__)) out& operator<<(const size_t& v) {operator()(v);return *this;}
    inline __attribute__((__always_inline__)) out& operator<<(const int& v) {operator()(v);return *this;}
    inline __attribute__((__always_inline__)) out& operator<<(const char& c) {operator()(c);return *this;}
    inline __attribute__((__always_inline__)) out& operator<<(const char* str) {operator()(str);return *this;}
    inline __attribute__((__always_inline__)) out& operator<<(const double& v) {operator()(v);return *this;}
    ...
    inline __attribute__((__always_inline__)) void operator()(Ty first,Args... args){
        operator()(first);
